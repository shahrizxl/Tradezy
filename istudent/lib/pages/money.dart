...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String? _selectedCategory = 'All'; // Default to show all transactions

  // List of purposes (categories) from AddTransactionScreen, plus "All"
  ...
  Future<void> _fetchTransactions() async {
    try {
      ...
      setState(() {
        ...
        _filterTransactions(); // Filter transactions based on current category
        _isLoading = false;
      });
    } catch (error) {
      setState(() {
      ...
      print('Error details: $error'); // Log the full error for debugging
    }
  }
            ...
            child: DropdownButtonFormField<String>(
              ...
              onChanged: (value) {
                setState(() {
                  ...
                  _filterTransactions(); // Update filtered transactions
                });
              },
  ...
  Future<void> _fetchStats() async {
    try {
      ...
      setState(() {
        ...
        print('Transactions by Purpose: $_transactionsByPurpose');
        print('Income by Month: $_incomeByMonth');
        print('Expenses by Month: $_expenseByMonth');
        _isLoading = false;
      });
    } catch (error) {
      setState(() {
  ...
  Future<void> _fetchTotalIncome() async {
    try {
      ...
      setState(() {
        ...
        _isLoading = false;
        print('Total Income: RM${_totalIncome!.toStringAsFixed(2)}');
        print('Needs (50% of Total Income): RM${_needs!.toStringAsFixed(2)}');
        print('Wants (30% of Total Income): RM${_wants!.toStringAsFixed(2)}');
        print('Savings (20% of Total Income): RM${_savings!.toStringAsFixed(2)}');
